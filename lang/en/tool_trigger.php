...
$string['privacy:general_data'] = 'Outgoing messages may be configured to include personal user data, course data, and events data.';
$string['privacy:step_action_email'] = 'This plugin may be configured to send emails containing data from Moodle. It does not store data locally.';
$string['privacy:step_action_httppost'] = 'This plugin may be configured to send HTTP requests to external addresses, containing data from Moodle. It does not store data locally.';
