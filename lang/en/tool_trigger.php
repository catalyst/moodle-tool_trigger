...
$string['async'] = 'Async';
$string['asyncmode'] = 'Async mode';
$string['asyncmode_help'] = 'If enabled workflows are processed asyncronously when triggered.';
$string['core'] = 'Core';
...
$string['httposttiggerparams_help'] = 'The arameters to send with the request.';
...
$string['step_help'] = 'Choose the step to apply.';
