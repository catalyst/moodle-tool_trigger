...
$string['step_lookup_context_name'] = 'Context lookup';
$string['step_lookup_context_desc'] = 'This step looks up data about context.';
$string['step_lookup_context_instanceid'] = 'Instance ID';
$string['step_lookup_context_mod'] = 'Activity type';
$string['instanceid'] = 'Instance ID';
$string['instanceid_help'] = 'You can use id as a number or as a filed name from the workflow data';
$string['step_lookup_context_contextlevel'] = 'Instance context level';
$string['step_lookup_context:privacy:contextdata_desc'] = 'Data about context, including id, instance id and etc.';
