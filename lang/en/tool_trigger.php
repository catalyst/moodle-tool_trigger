...
$string['webserviceactionstepname'] = 'Webservice execute';
$string['webserviceactionstepdesc'] = 'A step to execute Moodle webservices.';
...
$string['workflowimported'] = 'Workflow successfully importedd';
