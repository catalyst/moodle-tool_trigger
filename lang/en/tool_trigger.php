...
$string['httposttriggerurl'] = 'URL';
$string['httposttriggerurl_help'] = 'The URL to post the data to.';
$string['httposttriggerheaders'] = 'Headers';
$string['httposttriggerheaders_help'] = 'The requests headers to send.';
$string['httposttriggerparams'] = 'Parameters';
$string['httposttriggerparams_help'] = 'The parameters to send with the request.';
...
$string['step_trigger_logdump_desc'] = 'This step prints the event and workflow steps data to the cron log. (Mostly useful for testing.)';
$string['step_trigger_logdump_name'] = 'Cron log';
